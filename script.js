document.addEventListener('DOMContentLoaded', function () {
  ...
  const scrollElements = document.querySelectorAll(
    '.fade-in-on-scroll, [data-animate], section > *, .card, .feature, .testimonial, .pricing-card, .team-member, .hero-content, .section-header'
  );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עומר בגדים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '428d6746-4ae1-464a-a3b5-b5037199428e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '428d6746-4ae1-464a-a3b5-b5037199428e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '428d6746-4ae1-464a-a3b5-b5037199428e';
